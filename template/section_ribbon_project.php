...
<div class="ribbon-wrapper <?php echo $prlx_class;?>"  id="projects">
<section id="ribbon" class="ribbon_sec projektek_sec" data-center="<?php echo esc_attr($prlx_data_center);?>" data-top-bottom="<?php echo esc_attr($prlx_top_bottom);?>" style="" >
            <div class="container">
                <div class="ribon-box ">
...
<div class="section-navigate-background">
    <div class="section-navigate-background-text"><span><?php echo esc_html("PROJEKTEK", "oneline-lite");?></span></div>
</div>
