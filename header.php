...
<div id="header" class="header <?php echo $header_fixed_cls; ?> <?php echo $cntralign_menu; ?> <?php echo $split_menu; ?> <?php echo $header_hide; ?> <?php echo $hdr_trnsprnt; ?> <?php echo $last_btn; ?>" >
   <div class="header-top-bar">
      <div class="container clearfix">
        <div class="top-text-column top-text-column-left"><a href="https://amarwp.com/farkas/"><p>FARKAS TIBOR</p></a></div>
        <div class="top-text-column top-text-column-right"><p class="psudo-exclude">BÁTA IDÉÁLIS POLGÁRMESTER-JELÖLTJE</p></div>
      </div>
  ...
  <a class="skip-link screen-reader-text" href="#page"><?php _e( 'Skip to content', 'oneline-lite' ); ?></a>
        <div class="container clearfix shadow-menu">
